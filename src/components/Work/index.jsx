    ...
    <section className="cv" id="work-experience">
      ...
      <div className="other-stuff">
        <div className="work-experience">
          ...
          <h6>Digital Marketing Communication Manager / Israel Credit Cards</h6>
          <p>
            Monitored, analyzed, and executed all advertising activities in the
            credit (personal loan) field. Close work with R&D on all dev cycle –
            specification document to deployment, through production and various
            version releases. <br />
          </p>
          <h6>Advertising Manager / Mish’an Senior Living</h6>
          <p>
            Managed all marketing, advertising and PR activities for a chain of
            13 senior living homes. Developed the digital infrastructure. Tight
            working relations with sales.
            <br />
          </p>
          ...
          <p>
            In charge of all clients’ advertising activities while representing
            both client and agency interests. Managed six account managers.
        ...
        <div className="education" id="education">
          <h3>Education</h3>
          <p>
            Bachelor of Arts, Political Science / Ben-Gurion University / Israel
            <br />
